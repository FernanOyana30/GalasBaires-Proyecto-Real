        ...
        <Row>          
          <Col xsm={1} sm={1} md={12} lg={12}>            
            <Accordion className='acordeonStyle'>
              ...
              <Accordion.Item eventKey="5" className='acordeonItem'>
                <Accordion.Header className='acordeonHeader'>Políticas de entrega</Accordion.Header>
                <Accordion.Body>
              ...
              <Accordion.Item eventKey="6" className='acordeonItem'>
                <Accordion.Header className='acordeonHeader'>Recomendaciones de uso</Accordion.Header>
                <Accordion.Body>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                  eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
                  minim veniam, quis nostrud exercitation ullamco laboris nisi ut
